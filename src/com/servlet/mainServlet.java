...
public class mainServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//将过滤器中存入的playload数据取出来
		HashMap<String, String> data=(HashMap<String, String>) request.getAttribute("data");
		//playload中的数据可以用来做查询，比如我们在登陆成功时将用户ID存到了playload中，我们可以将它取出来，去数据库查询这个用户的所有信息；
		//而不是用request.getParameter("uid")方法来获取前端传给我们的uid，因为前端的参数时可篡改的不完全可信的，而我们从playload中取出来的数据是从token中
